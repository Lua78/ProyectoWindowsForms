...
namespace Farmacia_sis
{
    public partial class Proveedores : Form
    {
       ...
       private SQLConexion con;
        public Proveedores(SQLConexion con)
        {
            this.con = con;
            InitializeComponent();
        }
        ...
        {
            EditarProveedor de = new EditarProveedor(con,int.Parse(dataGridView1.Rows[indexData].Cells[0].Value.ToString()));
            de.Show();
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                con.EliminarProveedor(int.Parse(dataGridView1.Rows[indexData].Cells[0].Value.ToString()));
                con.GetProveedores(dataGridView1);
            }
        }
        ...
        {
            AgregarProveedor ap = new AgregarProveedor(con);
            ap.Show();
        }
    }
